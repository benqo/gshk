...
class WorkoutUseCase {
    ...
    func getSummary(days: Int, handler: @escaping ((WorkoutSummaryEntity) -> Void)) {
        repository.getWorkouts(days: days) { workouts in
            ...
            handler(.init(workouts: workouts, distance: distance, energy: energy,
